...
namespace LogXExplorer.Module.BusinessObjects.Database
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(AbcType),
            typeof(AccelarateType),
            typeof(Aisle),
            typeof(BusinessSettings),
            typeof(CommonTrDetail),
            typeof(CommonTrHeader),
            typeof(CommonTrType),
            typeof(CountryStates),
            typeof(Customer),
            typeof(CustomerSegment),
            typeof(InsertType),
            typeof(Iocp),
            typeof(LctProCon),
            typeof(Leltar),
            typeof(LoadCarrier),
            typeof(LoadCarrierType),
            typeof(Producer),
            typeof(Product),
            typeof(ProductProducts_AisleAisles),
            typeof(QtyExchange),
            typeof(Sorszam),
            typeof(Stock),
            typeof(StockHistory),
            typeof(StorageLocation),
            typeof(TransportOrder),
            typeof(UnitType),
            typeof(ProductGroup)
        };
