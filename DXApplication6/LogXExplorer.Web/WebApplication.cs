...
namespace LogXExplorer.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class LogXExplorerAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private LogXExplorer.Module.LogXExplorerModule module3;
        private LogXExplorer.Module.Web.LogXExplorerAspNetModule module4;
        ...
        static LogXExplorerAspNetApplication() {
        ...
        #endregion
        public LogXExplorerAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void LogXExplorerAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new LogXExplorer.Module.Web.LogXExplorerAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.LogXExplorerAspNetApplication_DatabaseVersionMismatch);
